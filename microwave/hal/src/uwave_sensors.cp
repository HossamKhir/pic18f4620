...
#line 6 "E:/embedded_diploma/projects/pic/microwave/hal/src/uwave_sensors.c"
void
UWAVE_SENSORS_vidInit(void)
{
 ...
 INTERRUPT_vidInit();
  ...
  ((INTCON3)&=(~(1<<IntFlag_RB_INT1_TMR1_CCP2))) ;
  ((INTCON3)&=(~(1<<IntFlag_INT0_INT2_TMR2_TMR3))) ;
 ...
 INTERRUPT_vidSetPriority(IntPr_INT2_PSP_OSCF,Pr_Low);
  ...
  (((INTCON3))|=(1<<IntEn_RB_INT1_SSP_BCL)) ;
  (((INTCON3))|=(1<<IntEn_INT0_INT2_TX_EE)) ;
}
