...
;timers.c,22 :: 		GET_TMR_CTRL_REG(TIMER0)   |=  (u16Prescaler[timerID][prescale][0] << (4 * (timerID % 2)));
	...
	MOVWF       R0 
	MOVF        R1, 0 
L_timers_TIMERS_vidSetScale19:
	BZ          L_timers_TIMERS_vidSetScale20
	RLCF        R0, 1 
	BCF         R0, 0 
	ADDLW       255
	GOTO        L_timers_TIMERS_vidSetScale19
L_timers_TIMERS_vidSetScale20:
	MOVF        R0, 0 
	IORWF       T0CON+0, 1 
;timers.c,23 :: 		break;
...
;timers.c,25 :: 		GET_TMR_CTRL_REG(TIMER1)   |=  (u16Prescaler[timerID][prescale][0] << (4 * (timerID % 2)));
	...
	MOVWF       R0 
	MOVF        R1, 0 
L_timers_TIMERS_vidSetScale21:
	BZ          L_timers_TIMERS_vidSetScale22
	RLCF        R0, 1 
	BCF         R0, 0 
	ADDLW       255
	GOTO        L_timers_TIMERS_vidSetScale21
L_timers_TIMERS_vidSetScale22:
	MOVF        R0, 0 
	IORWF       T1CON+0, 1 
;timers.c,26 :: 		break;
	GOTO        L_timers_TIMERS_vidSetScale1
...
;timers.c,28 :: 		GET_TMR_CTRL_REG(TIMER2)   |=  (u16Prescaler[timerID][prescale][0] << (4 * (timerID % 2)));
	...
	MOVWF       R0 
	MOVF        R1, 0 
L_timers_TIMERS_vidSetScale23:
	BZ          L_timers_TIMERS_vidSetScale24
	RLCF        R0, 1 
	BCF         R0, 0 
	ADDLW       255
	GOTO        L_timers_TIMERS_vidSetScale23
L_timers_TIMERS_vidSetScale24:
	MOVF        R0, 0 
	IORWF       T2CON+0, 1 
...
;timers.c,62 :: 		)
;timers.c,64 :: 		switch (timerID)
	GOTO        L_TIMERS_vidUpdateInitialCount6
;timers.c,66 :: 		case TIMER0:
L_TIMERS_vidUpdateInitialCount8:
;timers.c,67 :: 		case TIMER1:
L_TIMERS_vidUpdateInitialCount9:
;timers.c,68 :: 		case TIMER3:
L_TIMERS_vidUpdateInitialCount10:
;timers.c,69 :: 		u64InitialCount = (FULL_COUNT + 1) - (uint64)(u64TargetTime / (CYCLE_PERIOD * (double)u16Prescaler[timerID][prescale][1]));
	MOVLW       18
	MOVWF       R0 
	MOVLW       0
	MOVWF       R1 
	...
	MOVLW       0
	MOVWF       timers_u64InitialCount+0 
	MOVLW       0
	MOVWF       timers_u64InitialCount+1 
	MOVLW       1
	MOVWF       timers_u64InitialCount+2 
	MOVLW       0
	MOVWF       timers_u64InitialCount+3 
	MOVF        R0, 0 
	SUBWF       timers_u64InitialCount+0, 1 
	MOVF        R1, 0 
	SUBWFB      timers_u64InitialCount+1, 1 
	MOVF        R2, 0 
	SUBWFB      timers_u64InitialCount+2, 1 
	MOVF        R3, 0 
	SUBWFB      timers_u64InitialCount+3, 1 
;timers.c,70 :: 		break;
	GOTO        L_TIMERS_vidUpdateInitialCount7
;timers.c,71 :: 		case TIMER2:
L_TIMERS_vidUpdateInitialCount11:
;timers.c,72 :: 		u64InitialCount = (uint64)(u64TargetTime / (CYCLE_PERIOD * (double)u16Prescaler[timerID][prescale][1] * (postscale + 1)));
	MOVLW       18
	MOVWF       R0 
	MOVLW       0
	MOVWF       R1 
...
;timers.c,78 :: 		TIMERS_vidResetTimer(enTimer timerID)
;timers.c,80 :: 		switch (timerID)
	GOTO        L_TIMERS_vidResetTimer12
;timers.c,82 :: 		case TIMER0:
L_TIMERS_vidResetTimer14:
;timers.c,83 :: 		FILL_TMR_REGS(TIMER0,u64InitialCount);
	MOVLW       255
	ANDWF       timers_u64InitialCount+0, 0 
	MOVWF       TMR0L+0 
	MOVF        timers_u64InitialCount+1, 0 
	MOVWF       R0 
	MOVF        timers_u64InitialCount+2, 0 
	MOVWF       R1 
	MOVF        timers_u64InitialCount+3, 0 
	MOVWF       R2 
	CLRF        R3 
	MOVLW       255
	ANDWF       R0, 0 
	MOVWF       TMR0H+0 
;timers.c,84 :: 		CLR_TMR_INT_FLAG(TIMER0);
	BCF         INTCON+0, 2 
;timers.c,85 :: 		break;
	GOTO        L_TIMERS_vidResetTimer13
;timers.c,86 :: 		case TIMER1:
L_TIMERS_vidResetTimer15:
;timers.c,87 :: 		FILL_TMR_REGS(TIMER1,u64InitialCount);
	MOVLW       255
	ANDWF       timers_u64InitialCount+0, 0 
	MOVWF       TMR1L+0 
	MOVF        timers_u64InitialCount+1, 0 
	...
	ANDWF       R0, 0 
	MOVWF       TMR1H+0 
;timers.c,88 :: 		CLR_TMR_INT_FLAG(TIMER1);
	BCF         INTCON+0, 0 
;timers.c,89 :: 		break;
	GOTO        L_TIMERS_vidResetTimer13
;timers.c,90 :: 		case TIMER3:
L_TIMERS_vidResetTimer16:
;timers.c,91 :: 		FILL_TMR_REGS(TIMER3,u64InitialCount);
	MOVLW       255
	ANDWF       timers_u64InitialCount+0, 0 
	MOVWF       TMR3L+0 
	MOVF        timers_u64InitialCount+1, 0 
	...
	ANDWF       R0, 0 
	MOVWF       TMR3H+0 
;timers.c,92 :: 		CLR_TMR_INT_FLAG(TIMER3);
	BCF         INTCON+0, 1 
;timers.c,93 :: 		break;
	GOTO        L_TIMERS_vidResetTimer13
;timers.c,94 :: 		case TIMER2:
L_TIMERS_vidResetTimer17:
;timers.c,96 :: 		PR2 =   GET_TIME_REG_LOW(u64InitialCount);
	MOVLW       255
	ANDWF       timers_u64InitialCount+0, 0 
	MOVWF       PR2+0 
;timers.c,97 :: 		CLR_TMR_INT_FLAG(TIMER2);
	BCF         INTCON+0, 1 
;timers.c,98 :: 		break;
	GOTO        L_TIMERS_vidResetTimer13
;timers.c,99 :: 		}
