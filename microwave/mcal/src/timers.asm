...
;timers.c,42 :: 		uint64 u64TimeUnit)
;timers.c,44 :: 		u64TargetTime = GET_TIME_IN_USEC(u64TargetTime,u64TimeUnit);
...
;timers.c,45 :: 		TIMERS_vidUpdateInitialCount(u64TargetTime, timerID, prescale, postscale);
	MOVF        R0, 0 
...
;timers.c,46 :: 		TIMERS_vidSetScale(timerID, prescale, postscale);
	MOVF        FARG_TIMERS_vidInitTimer_timerID+0, 0 
...
;timers.c,47 :: 		TIMERS_vidResetTimer(timerID);
	MOVF        FARG_TIMERS_vidInitTimer_timerID+0, 0 
...
;timers.c,54 :: 		enPostscale postscale)
;timers.c,56 :: 		switch (timerID)
	GOTO        L_TIMERS_vidUpdateInitialCount6
;timers.c,58 :: 		case TIMER0:
L_TIMERS_vidUpdateInitialCount8:
;timers.c,59 :: 		case TIMER1:
L_TIMERS_vidUpdateInitialCount9:
;timers.c,60 :: 		case TIMER3:
L_TIMERS_vidUpdateInitialCount10:
;timers.c,61 :: 		u64InitialCount = (FULL_COUNT + 1) - (uint32)(u64TargetTime / (CYCLE_PERIOD * (double)u16Prescaler[timerID][prescale][1]));
	MOVLW       36
	MOVWF       R0 
	MOVLW       0
	MOVWF       R1 
...
;timers.c,63 :: 		case TIMER2:
L_TIMERS_vidUpdateInitialCount11:
;timers.c,64 :: 		u64InitialCount = (uint32)(u64TargetTime / (CYCLE_PERIOD * (double)u16Prescaler[timerID][prescale][1] * (postscale + 1)));
	MOVLW       36
	MOVWF       R0 
	MOVLW       0
	MOVWF       R1 
...
;timers.c,70 :: 		TIMERS_vidResetTimer(enTimer timerID)
;timers.c,72 :: 		switch (timerID)
	GOTO        L_TIMERS_vidResetTimer12
;timers.c,74 :: 		case TIMER0:
L_TIMERS_vidResetTimer14:
;timers.c,75 :: 		FILL_TMR_REGS(TIMER0,u64InitialCount);
	MOVLW       255
	...
	ANDWF       R0, 0 
	MOVWF       TMR0H+0 
;timers.c,76 :: 		CLR_TMR_INT_FLAG(TIMER0);
	BCF         INTCON+0, 2 
;timers.c,77 :: 		break;
	GOTO        L_TIMERS_vidResetTimer13
;timers.c,78 :: 		case TIMER1:
L_TIMERS_vidResetTimer15:
;timers.c,79 :: 		FILL_TMR_REGS(TIMER1,u64InitialCount);
	MOVLW       255
	ANDWF       _u64InitialCount+0, 0 
	MOVWF       TMR1L+0 
	MOVF        _u64InitialCount+1, 0 
	...
	ANDWF       R0, 0 
	MOVWF       TMR1H+0 
;timers.c,80 :: 		CLR_TMR_INT_FLAG(TIMER1);
	BCF         INTCON+0, 0 
;timers.c,81 :: 		break;
	GOTO        L_TIMERS_vidResetTimer13
;timers.c,82 :: 		case TIMER3:
L_TIMERS_vidResetTimer16:
;timers.c,83 :: 		FILL_TMR_REGS(TIMER3,u64InitialCount);
	MOVLW       255
	ANDWF       _u64InitialCount+0, 0 
	MOVWF       TMR3L+0 
	MOVF        _u64InitialCount+1, 0 
	...
	ANDWF       R0, 0 
	MOVWF       TMR3H+0 
;timers.c,84 :: 		CLR_TMR_INT_FLAG(TIMER3);
	BCF         INTCON+0, 1 
;timers.c,85 :: 		break;
	GOTO        L_TIMERS_vidResetTimer13
;timers.c,86 :: 		case TIMER2:
L_TIMERS_vidResetTimer17:
;timers.c,88 :: 		PR2 =   GET_TIME_REG_LOW(u64InitialCount);
	MOVLW       255
	ANDWF       _u64InitialCount+0, 0 
	MOVWF       PR2+0 
;timers.c,89 :: 		CLR_TMR_INT_FLAG(TIMER2);
	BCF         INTCON+0, 1 
;timers.c,90 :: 		break;
	GOTO        L_TIMERS_vidResetTimer13
;timers.c,91 :: 		}
...
;timers.c,95 :: 		TIMERS_vidConfigTimerInterrupts(enTimer timerID, enPriority priority)
;timers.c,97 :: 		INTERRUPT_vidInit();
	CALL        _INTERRUPT_vidInit+0, 0
;timers.c,99 :: 		switch(timerID)
	GOTO        L_TIMERS_vidConfigTimerInterrupts18
;timers.c,101 :: 		case TIMER0:
L_TIMERS_vidConfigTimerInterrupts20:
;timers.c,102 :: 		CLR_TMR_INT_FLAG(TIMER0);
	BCF         INTCON+0, 2 
;timers.c,103 :: 		INTERRUPT_vidSetPriority(IntPr_TMR0_CCP1_HLVD, priority);
	MOVLW       2
...
;timers.c,104 :: 		INTERRUPT_ENABLE_SRC(INTERRUPT_REG_EN_TMR0,IntEn_TMR0_RX);
	BSF         INTCON+0, 5 
;timers.c,105 :: 		break;
	GOTO        L_TIMERS_vidConfigTimerInterrupts19
;timers.c,106 :: 		case TIMER1:
L_TIMERS_vidConfigTimerInterrupts21:
;timers.c,107 :: 		CLR_TMR_INT_FLAG(TIMER1);
	BCF         INTCON+0, 0 
;timers.c,108 :: 		INTERRUPT_vidSetPriority(IntPr_RB_TMR1_CCP2, priority);
	CLRF        FARG_INTERRUPT_vidSetPriority+0 
	MOVF        FARG_TIMERS_vidConfigTimerInterrupts_priority+0, 0 
	MOVWF       FARG_INTERRUPT_vidSetPriority+0 
	CALL        _INTERRUPT_vidSetPriority+0, 0
;timers.c,109 :: 		INTERRUPT_ENABLE_SRC(INTERRUPT_REG_EN_TMR1_TMR2,IntEn_TMR1_CCP2);
	BSF         PIE1+0, 0 
;timers.c,110 :: 		break;
	GOTO        L_TIMERS_vidConfigTimerInterrupts19
;timers.c,111 :: 		case TIMER2:
L_TIMERS_vidConfigTimerInterrupts22:
;timers.c,112 :: 		CLR_TMR_INT_FLAG(TIMER2);
	BCF         INTCON+0, 1 
;timers.c,113 :: 		INTERRUPT_vidSetPriority(IntPr_TMR2_TMR3, priority);
	MOVLW       1
	MOVWF       FARG_INTERRUPT_vidSetPriority+0 
	MOVF        FARG_TIMERS_vidConfigTimerInterrupts_priority+0, 0 
	MOVWF       FARG_INTERRUPT_vidSetPriority+0 
	CALL        _INTERRUPT_vidSetPriority+0, 0
;timers.c,114 :: 		INTERRUPT_ENABLE_SRC(INTERRUPT_REG_EN_TMR1_TMR2,IntEn_TMR2_TMR3);
	BSF         PIE1+0, 1 
;timers.c,115 :: 		break;
	GOTO        L_TIMERS_vidConfigTimerInterrupts19
;timers.c,116 :: 		case TIMER3:
L_TIMERS_vidConfigTimerInterrupts23:
;timers.c,117 :: 		CLR_TMR_INT_FLAG(TIMER3);
	BCF         INTCON+0, 1 
;timers.c,118 :: 		INTERRUPT_vidSetPriority(IntPr_TMR2_TMR3, priority);
	MOVLW       1
	MOVWF       FARG_INTERRUPT_vidSetPriority+0 
	MOVF        FARG_TIMERS_vidConfigTimerInterrupts_priority+0, 0 
	MOVWF       FARG_INTERRUPT_vidSetPriority+0 
	CALL        _INTERRUPT_vidSetPriority+0, 0
;timers.c,119 :: 		INTERRUPT_ENABLE_SRC(INTERRUPT_REG_EN_TMR3,IntEn_TMR2_TMR3);
	BSF         PIE2+0, 1 
;timers.c,120 :: 		break;
	GOTO        L_TIMERS_vidConfigTimerInterrupts19
;timers.c,121 :: 		}
